...
These code are removed from the charlstone index as they are the outcome, they will be included
...
```{r}
sos_before_exposure <- 
sos_data |> left_join(scb |> select(LopNr, Year), join_by(LopNr)) |> 
...
icd10 <- paste("\\<I110|\\<I130|\\<I132|\\<I255|\\<I420|\\<I426|\\<I427|\\<I428|\\<I429|\\<I43|\\<I50",icd9, sep="|")
...
icd10 <- paste("\\<I70|\\<I71|\\<I731|\\<I738|\\<I739|\\<I771|\\<I790|\\<I792|\\<K55", icd9, sep="|")
...
icd10 <- paste(paste(c("\\<J45",41,42,46,47,60:70),collapse="|\\<J"), icd9, sep="|")
...
icd10 <- paste(paste(c("\\<M05","06",123,"070","071","072","073","08",13,30,313:316,32:34,350:351,353,45:46),collapse="|\\<M"), icd9, sep="|")
...
icd10 <- paste("\\<F00|\\<F01|\\<F02|\\<F03|\\<F051|\\<G30|\\<G311|\\<G319", icd9, sep="|")
...
icd10 <- paste("\\<G114|\\<G80|\\<G81|\\<G82|\\<G830|\\<G831|\\<G832|\\<G833|\\<G838", icd9, sep="|")
...
icd9 <- "\\<250A|\\<250B|\\<250C"
icd10 <- paste("\\<E100|\\<E101|\\<E110|\\<E111|\\<E120|\\<E121|\\<E130|\\<E131|\\<E140|\\<E141", icd9, sep="|")
...
icd10 <- paste("\\<E102|\\<E103|\\<E104|\\<E105|\\<E107|\\<E112|\\<E113|\\<E114|\\<E115|\\<E116|\\<E117|\\<E122|\\<E123|\\<E124|\\<E125|\\<E126|\\<E127|\\<E132|\\<E133|\\<E134|\\<E135|\\<E136|\\<E137|\\<E142|\\<E143|\\<E144|\\<E145|\\<E146|\\<E147", icd9, sep="|")
...
icd10 <- paste("\\<I120|\\<I131|\\<N032|\\<N033|\\<N034|\\<N035|\\<N036|\\<N037|\\<N052|\\<N053|\\<N054|\\<N055|\\<N056|\\<N057|\\<N11|\\<N18|\\<N19|\\<N250|\\<Q611|\\<Q612|\\<Q613|\\<Q614|\\<Z49|\\<Z940|\\<Z992", icd9, sep="|")
...
icd10 <- paste("\\<B15|\\<B16|\\<B17|\\<B18|\\<B19|\\<K703|\\<K709|\\<K73|\\<K746|\\<K754", icd9, sep="|")
...
icd10  <- paste(paste("\\<C00|\\<C0",paste(1:9,collapse = "|\\<C0",sep=""),paste("|\\<C",paste(c(10:41,43,45:58,60:76,81:86,88:97),collapse = "|\\<C"),sep=""),sep=""), icd9, sep="|")
...
# Aids
icd9  <- "\\<079J|\\<279K"
icd10 <- paste("\\<B20|\\<B21|\\<B22|\\<B23|\\<B24|\\<F024|\\<O987|\\<R75|\\<Z219|\\<Z717", icd9, sep="|")
...
```{r}
Matrix |> pivot_longer(cols = c(everything(), -group))  |>  count(name, value) |> 
  print(n=100)

Matrix |> pivot_longer(cols = c(everything(), -group))  |>  count(value) |> 
  print(n=100)
```

```{r}
write_csv(Matrix, here::here("..", "data", "charlson_comorbidity_index_results.csv"))
```
