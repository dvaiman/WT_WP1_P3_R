...
joined2 <-
  ...
  mutate(
    ...
    censor_date_1y = pmin(
      HPA_date + days(3652), # cap at 10 y from the HPA (SAME as censor_date_10yrs),
      # NOT risk_start_1y + years(10), which is 11 y from the HPA and adds a year
      # of follow-up — a wash-out must stay inside the primary's 10-year window.
      DODSDAT,
      admin_censor,
      na.rm = TRUE
    ),
