...
build_hr_plot <- function(groups, ncol = NULL, show_strip = FALSE,
  ...
  dat <- hr_table |>
    ...
    mutate(Group = factor(Group, levels = c("Overall", "HPA count", "Sex", "Age grp")))
  ...
  dat |>
    ...
    geom_ribbon(aes(ymin = ratio_lci, ymax = ratio_uci, group = factor(Subgroup)),
    ...
    # (no scale_fill_manual: the ribbon uses a fixed grey fill, not a mapped one)
