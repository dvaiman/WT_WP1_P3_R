...
forest_plot(
  ...
  add = list(
    start = list(
      ...
      labs(
        caption = paste(
          "Main models (M1–M5) and effect modification by sex, age and education are pre-specified.",
          "Number of assessments and lifestyle blocks are exploratory bias probes.",
          "*Lifestyle related variables were available only for HPA participants.",
          sep = "\n"
        )
      ),
      ...
      theme(
        ...
        # single font family: ggplot2 4.0's text engine cannot recycle a vector
        # of families across all text elements (the old 5-font vector errored).
...
ggsave(
  here::here(
    ...
    "results",
    "figures",
    "forest_plot_ten_yr_lifestyle_interaction_HR_2.pdf"
  ),
  width = 210,
  height = 280,
  units = "mm",
...
ggsave(
  here::here(
    ...
    "results",
    "figures",
    "forest_plot_ten_yr_lifestyle_interaction_HR_2.svg"
  ),
  width = 210,
  height = 280,
  units = "mm",
